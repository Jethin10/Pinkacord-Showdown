...
if(options.mod&&species.num>=10000){
...
};this.modid=modid;var gen=parseInt(modid.charAt(3),10);if(this.modid==='champions')gen=9;if(this.modid==='pinkacord')gen=9;if(modid!=='champions'&&modid!=='pinkacord'&&!modid.startsWith('gen')||!gen)throw new Error("Unsupported modid");this.gen=gen;}var _proto3=ModdedDex.prototype;_proto3.
